...
public class ProductController {
  ...
  @GetMapping("/list/sort/starscore")
  public String sortStarScorelist(Model model,
                     @RequestParam(value = "page", defaultValue = "1") int page,
                     @RequestParam(value = "kw", defaultValue = "") String kw,
                     @RequestParam(value = "category", defaultValue = "", required = false) String category,
                     @RequestParam(value = "subCategory", defaultValue = "", required = false) String subCategory){
    ...
    if (page <= 0) {
      return "redirect:/product/list?category=" + category + "&subCategory=" + subCategory +"/sort/starscore" + "&page=1";
    }

    Page<Product> products = this.productService.getStarScore(category, subCategory, page, kw);
    List<String> subCategories = this.productService.getSubCategoriesByCategory(category);
  ...
  @GetMapping("/list/sort/lowprice")
  public String sortLowPricelist(Model model,
                                  @RequestParam(value = "page", defaultValue = "1") int page,
                                  @RequestParam(value = "kw", defaultValue = "") String kw,
                                  @RequestParam(value = "category", defaultValue = "", required = false) String category,
                                  @RequestParam(value = "subCategory", defaultValue = "", required = false) String subCategory){
    ...
    if (page <= 0) {
      return "redirect:/product/list?category=" + category + "&subCategory=" + subCategory +"/sort/lowprice" + "&page=1";
    }

    Page<Product> products = this.productService.getLowPrice(category, subCategory, page, kw);
    List<String> subCategories = this.productService.getSubCategoriesByCategory(category);
  ...
  @GetMapping("/list/sort/highprice")
  public String sortHighPricelist(Model model,
                                 @RequestParam(value = "page", defaultValue = "1") int page,
                                 @RequestParam(value = "kw", defaultValue = "") String kw,
                                 @RequestParam(value = "category", defaultValue = "", required = false) String category,
                                 @RequestParam(value = "subCategory", defaultValue = "", required = false) String subCategory){
    ...
    if (page <= 0) {
//      return "redirect:/product/list?category=" + category + "&subCategory=" + subCategory + "&page=1";
      return "redirect:/product/list?category=" + category + (subCategory != null ? "&subCategory=" + subCategory : "") + "/sort/highprice" + "&page=1";
    }

    Page<Product> products = this.productService.getHighPrice(category, subCategory, page, kw);
    List<String> subCategories = this.productService.getSubCategoriesByCategory(category);
